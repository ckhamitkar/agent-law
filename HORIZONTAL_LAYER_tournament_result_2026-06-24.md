...
- The **constitutional floor rule** — "the most protective constraint applies" = the monotone-meet FLOOR (his strongest, most under-used primitive). "Only humans write the constitution" = the home for the L6 terminus + the gravity classifier.
...
- **a reference agentic pipeline** (`workflow.py`) — the skeleton AND the embodied gap:
